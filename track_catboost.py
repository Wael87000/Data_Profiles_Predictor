...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_name", dest="experiment_name", help="Experiment name", default="CatBoost Experiment")
    parser.add_argument("--model_name", dest="model_name", help="Registered model name", default="Catboost")
    ...
    parser.add_argument("--depth", dest="depth", help="depth", default=6)#3
    ...
    train(args.data_path, args.n_estimators, args.loss_function, args.learning_rate, args.depth, args.task_type, args.random_state, args.verbose, model_name)
